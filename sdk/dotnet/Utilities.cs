...
namespace Pulumi.Veco
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Veco.version.txt");
    ...
    internal sealed class VecoResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public VecoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
